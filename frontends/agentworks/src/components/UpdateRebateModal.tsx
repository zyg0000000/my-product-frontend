    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="w-full max-w-2xl rounded-lg bg-white shadow-xl">
        ...
        <div className="p-6 space-y-6">
          {/* 当前返点率 */}
          <div className="rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 p-5 border border-blue-200">
              ...
              {rebateMode === 'sync' && (
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
                  >

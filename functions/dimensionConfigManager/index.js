/**
 * dimensionConfigManager - 维度配置管理云函数
 * 版本: v1.0
 * 描述: RESTful API，支持维度配置的 CRUD 操作
 *
 * 支持的HTTP方法:
 * - GET: 查询维度配置
 * - POST: 创建新配置
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const collection = db.collection('dimension_configs');
    ...
    console.error('Error in dimensionConfigManager:', error);
    return {
      statusCode: 500,
      headers,

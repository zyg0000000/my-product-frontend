#!/bin/bash
# database/scripts/sync-schema.sh
# 从 MongoDB 同步 Schema 到 Git 仓库
#
# 使用方法:
...
sync_collection() {
    ...
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${BLUE}📦 同步集合: $collection${NC}"
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    ...
    if [ "$dry_run" = "true" ]; then
        ...
        # 检查是否需要更新其他文件
        echo ""
        echo -e "${YELLOW}⚠️  提醒: 如果有新增或修改字段，请考虑更新:${NC}"
        echo -e "   1. ${target_file%.schema.json}.doc.json ${YELLOW}(添加中文说明)${NC}"
        echo -e "   2. database/indexes/${collection}.indexes.json ${YELLOW}(如需新索引)${NC}"
        echo -e "   3. database/schemas/INDEX.md ${YELLOW}(如是重大变更)${NC}"
    fi
...
main() {
    ...
    # 显示配置
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${BLUE}🚀 MongoDB Schema 同步工具${NC}"
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    ...
    if [ "$dry_run" != "true" ] && [ $success_count -gt 0 ]; then
        ...
        echo -e "1. 检查变更: ${GREEN}git diff database/schemas/${NC}"
        echo -e "2. 更新相关文件（如需要）"

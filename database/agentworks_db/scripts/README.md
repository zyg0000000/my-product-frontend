...
| 脚本 | 用途 | 状态 | 版本 |
|------|------|------|------|
| `init-talents.js` | 初始化 talents 集合和索引 | ✅ 可用 | v2.0 |
| `init-agencies.js` | 初始化 agencies 集合和索引 | ✅ 可用 | v1.0 |
| `migrate-talent-agency-relation.js` | 迁移达人-机构关系数据 | ✅ 可用 | v1.0 |
| `init-rebate-system.js` | 初始化返点管理系统 | ✅ 可用 | v2.1 |
| `init-counters.js` | 初始化计数器集合 | ✅ 可用 | v1.0 |
| `sync-schema.sh` | 从 MongoDB 同步 Schema | ✅ 可用 | v2.0 |

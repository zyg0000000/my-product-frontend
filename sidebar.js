...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setSidebarState(isCollapsed) {
        ...
        // ==================================================================
        // 您可以在这里手动调整侧边栏展开时的宽度。
        // 请确保下面的 Tailwind 宽度类 (例如 'w-64') 和 margin-left 的值 (例如 '16rem') 是匹配的。
        //
        // 常用 Tailwind 宽度单位换算：
        // w-56 -> 14rem
        // w-60 -> 15rem
        ...
        //
        // ==================================================================
        const expandedWidthClass = 'w-44'; // <--- 1. 在这里修改宽度类
        const expandedMargin = '10rem';    // <--- 2. 在这里修改对应的 margin 值

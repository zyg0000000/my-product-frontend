...
| 环境 | Node.js | npm | antd 版本 |
|------|---------|-----|-----------|
| 本地开发 | 22.x | 11.x | v6.0.1 ✅ |
| Cloudflare | 22.x | 10.x | v6.0.1 ✅ |

> 📌 通过 `.nvmrc` 指定 Node.js 22 + `package.json` 的 `overrides` 字段，确保本地和 Cloudflare 环境使用相同的 antd v6 版本。
